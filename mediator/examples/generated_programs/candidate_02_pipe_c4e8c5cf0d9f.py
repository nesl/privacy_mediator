#!/usr/bin/env python3
"""Executable SmartPriv pipeline generated from symbolic candidate pipe_c4e8c5cf0d9f.

Usage:
  python candidate_02_pipe_c4e8c5cf0d9f.py --input frame.jpg --output out.json
  python candidate_02_pipe_c4e8c5cf0d9f.py --input audio.wav --output out.json --media-type audio/x-raw
"""
